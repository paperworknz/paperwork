...
Form.prototype.copy = function(form, templates){
	...
	$('.copy-content .copy-parent').append(`
		<div class="container wrap">
			<button copy-cancel class="button blue right" data-button-state="off">
				CANCEL
			</button>
		</div>
	`);
	...
	fade.after(`
		<div class="email-content">
			<div class="email-parent wrap container">
				<input class="email-email" type="text" style="width:50%" value="${job.client_email}" placeholder="Email Address" required />
				...
				<div class="wrap">
					...
					<button email-cancel class="button blue right" style="margin-right:5px" data-button-state="off">CANCEL</button>
